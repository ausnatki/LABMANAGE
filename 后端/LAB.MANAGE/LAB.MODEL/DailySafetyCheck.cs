...
namespace LAB.MODEL
{
    ...
    public class DailySafetyCheck // 实验室管理人员日常检查表
    {
        ...
        public LAB.MODEL.Semesters? Semesters { get; set; }
        public List<LAB.MODEL.LabInclidentHanding>? labInclidentHanding {  get; set; }
        public List<LAB.MODEL.LabEquipmentRepairs>? labEquipmentRepairs { get; set; }
    }
}
